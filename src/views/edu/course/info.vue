  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item>
        ...
        <el-button :disabled="saveBtnDisabled" type="primary" @click="saveEduINfo">下一步</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  methods: {
    saveEduINfo(){
      this.$store.commit('eduPublish/setInfo',this.courseInfo);
      this.$router.push({
          path: "/course/chapter"
        })
    },
    showEduINfo(){
      let info = this.$store.getters.getEduPublish
      alert(info.title)
    },
    //根据课程id查询
    getInfo() {
